...
export interface Address extends std.$Object {
  "city": string;
  "country": string;
  "pincode": string;
}
export interface Certifications extends std.$Object {
...
export interface PersonalDetails extends std.$Object {
...
export interface SocialMediaProfile extends std.$Object {
  "network"?: string | null;
  "url"?: string | null;
}
export interface WorkExperience extends std.$Object {
